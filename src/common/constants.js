...
export const CLASS_POPOVER_INDICATION_FOOTER = 'driver-popover-indication-footer';
export const CLASS_POPOVER_INDICATION_BOX = 'driver-popover-indication-box';
export const CLASS_INDICATION_NEXT_STEP_BTN = 'driver-indication-btn';
...
export const CLASS_CLOSE_RIGHT_TOP_BTN = 'driver-close-right-top-btn';

// NOTE: It must match the one set in the animations in CSS file
export const ANIMATION_DURATION_MS = 300;

// language=HTML
export const POPOVER_HTML = ({className = '', rightTopCloseBtnClassName = '', nextBtnClassName}) => `
  <div id="${ID_POPOVER}" class="${className}">
    ...
    <div class="driver-clearfix ${CLASS_POPOVER_INDICATION_FOOTER}">
      <ul class="${CLASS_POPOVER_INDICATION_BOX}"></ul>
      <div class="btn_box">
        <button class="${CLASS_INDICATION_NEXT_STEP_BTN} ${nextBtnClassName}">Next &rarr;</button>
      </div>
    </div>
    <div class="${CLASS_CLOSE_RIGHT_TOP_BTN} ${rightTopCloseBtnClassName}"></div>
  </div>`;
